...
```bash
kbb -M:dev:run     # walk two clean publish(+delist) lifecycles (no source consent required, source consent required-and-verified), plus five HARD-hold cases, through the actor
...
superproject **ADR-2607261600**: この actor は職業安定法5条の4（的確表示義務）を
